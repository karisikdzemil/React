...
export default function Login() {
  ...
  const {value: passwordValue, handleInputChange: handlePasswordChange, handleInpuBlur: handlePasswordBlur, hasError: passwordHasError} = useInput('', (value) => hasMinLength(value, 6));
